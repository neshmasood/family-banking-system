...
urlpatterns = [
    ...
    path('families/', views.families_index, name='families_index'),
    path('families/<int:family_id>', views.families_show, name='families_show'),
    path('families/create/', views.Family_Create.as_view(), name='families_create'),
    path('families/<int:pk>/update/', views.Family_Update.as_view(), name='families_update'),
    path('families/<int:pk>/delete/', views.Family_Delete.as_view(), name='families_delete'),
